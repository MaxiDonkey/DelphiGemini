...
| Text generation streamed | ● | [**#section**](generations-json-payload-builder.md#expected-json-payload) | [**#streamied**](generations-sse.md#1-synchronous-streaming-direct-consumption) | [**#section**](generations-sse.md#2-asynchronous-streaming-with-session-callbacks) |
