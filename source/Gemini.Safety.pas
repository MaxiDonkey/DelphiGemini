...
type
  ...
  public
    ...
    /// <summary>
    /// Creates a <c>TSafety</c> setting for the Derogatory category with the
    /// specified threshold.
    /// </summary>
    /// <param name="Value">
    /// The harm block threshold to set for the Derogatory category.
    /// </param>
    /// <returns>
    /// A <c>TSafety</c> record for the Derogatory category with the specified
    /// threshold.
    /// </returns>
    class function Derogatory(const Value: THarmBlockThreshold): TSafety; static;

    /// <summary>
    /// Creates a <c>TSafety</c> setting for the Toxicity category with the
    /// specified threshold.
    /// </summary>
    /// <param name="Value">
    /// The harm block threshold to set for the Toxicity category.
    /// </param>
    /// <returns>
    /// A <c>TSafety</c> record for the Toxicity category with the specified
    /// threshold.
    /// </returns>
    class function Toxicity(const Value: THarmBlockThreshold): TSafety; static;

    /// <summary>
    /// Creates a <c>TSafety</c> setting for the Violence category with the
    /// specified threshold.
    /// </summary>
    /// <param name="Value">
    /// The harm block threshold to set for the Violence category.
    /// </param>
    /// <returns>
    /// A <c>TSafety</c> record for the Violence category with the specified
    /// threshold.
    /// </returns>
    class function Violence(const Value: THarmBlockThreshold): TSafety; static;

    /// <summary>
    /// Creates a <c>TSafety</c> setting for the Medical category with the
    /// specified threshold.
    /// </summary>
    /// <param name="Value">
    /// The harm block threshold to set for the Medical category.
    /// </param>
    /// <returns>
    /// A <c>TSafety</c> record for the Medical category with the specified
    /// threshold.
    /// </returns>
    class function Medical(const Value: THarmBlockThreshold): TSafety; static;

    /// <summary>
    /// Creates a <c>TSafety</c> setting for the Dangerous category with the
    /// specified threshold.
    /// </summary>
    /// <param name="Value">
    /// The harm block threshold to set for the Dangerous category.
    /// </param>
    /// <returns>
    /// A <c>TSafety</c> record for the Dangerous category with the specified
    /// threshold.
    /// </returns>
    class function Dangerous(const Value: THarmBlockThreshold): TSafety; static;
  end;
...
class function TSafety.Dangerous(const Value: THarmBlockThreshold): TSafety;
begin
  Result := TSafety.New(HARM_CATEGORY_DANGEROUS, Value);
end;
