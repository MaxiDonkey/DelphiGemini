...
type
  ...
  /// </summary>
  EGeminiExceptionAPI = class(Exception);
  ...
  /// </remarks>
  EInvalidArgument = class(EGeminiException);
  ...
  /// </remarks>
  EPermissionDenied = class(EGeminiException);
  ...
  /// </remarks>
  EResourceNotFound = class(EGeminiException);
  ...
  /// </remarks>
  EResourceExhausted = class(EGeminiException);
  ...
  /// </remarks>
  EInternalError = class(EGeminiException);
  ...
  /// </remarks>
  ETryAgain = class(EGeminiException);
  ...
  /// </remarks>
  EDeadlineExceeded = class(EGeminiException);
  ...
  /// Check if all parameters in your request are valid for your API version.
  /// </remarks>
  EInvalidResponse = class(EGeminiException);

implementation

{ EGeminiException }

constructor EGeminiException.Create(const ACode: Int64; const AError: TErrorCore);
begin
  Code := ACode;
...
constructor EGeminiException.Create(const ACode: Int64; const Value: string);
begin
  Code := ACode;
  Msg := Value;
