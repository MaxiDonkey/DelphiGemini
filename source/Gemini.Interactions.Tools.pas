...
type
  ...
  TMcpServerIxParams = class(TCustomToolIxParams)
    ...
    /// The allowed tools.
    /// </summary>
    function AllowedTools(const Value: TJSONObject): TMcpServerIxParams; overload;

    /// <summary>
    /// The allowed tools.
    /// </summary>
    function AllowedTools(const Value: TAllowedToolsIxParams): TMcpServerIxParams; overload;

    /// <summary>
    /// The allowed tools.
    /// </summary>
    function AllowedTools(const Value: string): TMcpServerIxParams; overload;
...
function TMcpServerIxParams.AllowedTools(
  const Value: TJSONObject): TMcpServerIxParams;
begin
  Result := TMcpServerIxParams(Add('allowed_tools', Value));
end;

function TMcpServerIxParams.AllowedTools(
  const Value: TAllowedToolsIxParams): TMcpServerIxParams;
begin
  Result := Self.AllowedTools(Value.Detach);
end;

function TMcpServerIxParams.AllowedTools(
  const Value: string): TMcpServerIxParams;
begin
  Result := Self.AllowedTools(TJSONHelper.StringToJson(Value));
end;
